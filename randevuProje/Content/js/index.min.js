            ...
            e.exports = function () {
                ...
                const e = "SweetAlert2:"
                    ...
                    , ne = (e, t, n) => {
                        if (te(e, t),
                            ...
                            if ("string" != typeof t.customClass[n] && !t.customClass[n].forEach)
                                return i("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(typeof t.customClass[n], '"'));
                    ...
                    , be = function (e) {
                        ...
                        const n = W();
                        he(n) && (t && (n.style.transition = "none",
                            n.style.width = "100%"),
                            setTimeout((() => {
                    ...
                    , xe = {}
                    , Te = () => {
                        xe.previousActiveElement && xe.previousActiveElement.focus ? (xe.previousActiveElement.focus(),
                            xe.previousActiveElement = null) : document.body && document.body.focus()
                    }
                    , Se = e => new Promise((t => {
                        if (!e)
                            return t();
                    ...
                    , ke = () => {
                        const e = O();
                        return !!e && (e.remove(),
                            ae([document.documentElement, document.body], [k["no-backdrop"], k["toast-shown"], k["has-column"]]),
                            !0)
                    }
                    , Pe = () => {
                    ...
                    , _e = (e, t) => {
                        const n = V()
                            , s = q();
                        t.showConfirmButton || t.showDenyButton || t.showCancelButton ? de(n) : ue(n),
                            ne(n, t, "actions"),
                            Ne(n, s, t),
                            Q(s, t.loaderHtml),
                            ne(s, t, "loader")
                ...
                function Ne(e, t, n) {
                    ...
                    qe(s, "confirm", n),
                        ...
                        qe(r, "cancel", n),
                        He(s, i, r, n),
                        n.reverseButtons && (n.toast ? (e.insertBefore(r, s),
                            e.insertBefore(i, s)) : (e.insertBefore(r, t),
                                e.insertBefore(i, t),
                                e.insertBefore(s, t)))
                }
                function He(e, t, n, s) {
                    if (!s.buttonsStyling)
                        return ae([e, t, n], k.styled);
                    oe([e, t, n], k.styled),
                        s.confirmButtonColor && (e.style.backgroundColor = s.confirmButtonColor,
                            oe(e, k["default-outline"])),
                        s.denyButtonColor && (t.style.backgroundColor = s.denyButtonColor,
                            oe(t, k["default-outline"])),
                        s.cancelButtonColor && (n.style.backgroundColor = s.cancelButtonColor,
                ...
                function Ve(e, t) {
                    t in k ? oe(e, k[t]) : (i('The "position" parameter is not valid, defaulting to "center"'),
                        oe(e, k.center))
                }
                function Fe(e, t) {
                ...
                const Ye = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
                    ...
                    , nt = {};
                nt.text = nt.email = nt.password = nt.number = nt.tel = nt.url = (e, t) => ("string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : p(t.inputValue) || i('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')),
                    et(e, e, t),
                    Qe(e, t),
                    e.type = t.input,
                    e),
                ...
                const st = (e, t) => {
                    ...
                    , ot = (e, t) => {
                        const n = Re.innerParams.get(e)
                            , s = B();
                        return n && t.icon === n.icon ? (ut(s, t),
                            void at(s, t)) : t.icon || t.iconHtml ? t.icon && -1 === Object.keys(P).indexOf(t.icon) ? (r('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')),
                                ue(s)) : (de(s),
                                    ut(s, t),
                                    at(s, t),
                                    void oe(s, t.showClass.icon)) : ue(s)
                    }
                    , at = (e, t) => {
                        for (const n in P)
                            t.icon !== n && ae(e, P[n]);
                    ...
                    , ut = (e, t) => {
                        e.textContent = "",
                            t.iconHtml ? Q(e, mt(t.iconHtml)) : "success" === t.icon ? Q(e, ct) : "error" === t.icon ? Q(e, dt) : Q(e, mt({
                                question: "?",
                                warning: "!",
                                info: "i"
                            }[t.icon]))
                    ...
                    , ft = e => {
                        ...
                        return oe(t, k["progress-step"]),
                            Q(t, e),
                            t
                    }
                    , gt = e => {
                        const t = document.createElement("li");
                        return oe(t, k["progress-step-line"]),
                    ...
                    , vt = (e, t) => {
                        ...
                        de(n),
                            n.textContent = "",
                            t.currentProgressStep >= t.progressSteps.length && i("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
                            t.progressSteps.forEach(((e, s) => {
                                const i = ft(e);
                                if (n.appendChild(i),
                                    s === t.currentProgressStep && oe(i, k["active-progress-step"]),
                    ...
                    , wt = (e, t) => {
                        ...
                        t.toast ? (ce(n, "width", t.width),
                            s.style.width = "100%",
                            s.insertBefore(q(), B())) : ce(s, "width", t.width),
                    ...
                    , yt = (e, t) => {
                        e.className = "".concat(k.popup, " ").concat(he(e) ? t.showClass.popup : ""),
                            t.toast ? (oe([document.documentElement, document.body], k["toast-shown"]),
                                oe(e, k.toast)) : oe(e, k.modal),
                            ne(e, t, "popup"),
                    ...
                    , Tt = () => {
                        s(document.body.children).forEach((e => {
                            e === O() || e.contains(O()) || (e.hasAttribute("aria-hidden") && e.setAttribute("data-previous-aria-hidden", e.getAttribute("aria-hidden")),
                    ...
                    , Ot = e => {
                        ...
                        return s(e.querySelectorAll("swal-button")).forEach((e => {
                            ...
                            t["".concat(s, "ButtonText")] = e.innerHTML,
                                ...
                                e.hasAttribute("color") && (t["".concat(s, "ButtonColor")] = e.getAttribute("color")),
                                e.hasAttribute("aria-label") && (t["".concat(s, "ButtonAriaLabel")] = e.getAttribute("aria-label"))
                        }
                        )),
                            t
                    }
                    , At = e => {
                        ...
                        return n && (It(n, ["src", "width", "height", "alt"]),
                    ...
                    , Lt = e => {
                        ...
                        n && (It(n, ["type", "label", "placeholder", "value"]),
                        ...
                        return i.length && (t.inputOptions = {},
                            s(i).forEach((e => {
                                It(e, ["value"]);
                    ...
                    , $t = e => {
                        ...
                        s(e.children).forEach((e => {
                            ...
                            -1 === t.indexOf(n) && i("Unrecognized element <".concat(n, ">"))
                        }
                        ))
                    }
                    , It = (e, t) => {
                ...
                function zt(e) {
                    (!e.target || "string" == typeof e.target && !document.querySelector(e.target) || "string" != typeof e.target && !e.target.appendChild) && (i('Target parameter is not valid, defaulting to "body"'),
                        e.target = "body")
                }
                function _t(e) {
                    Dt(e),
                        e.showLoaderOnConfirm && !e.preConfirm && i("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"),
                        zt(e),
                ...
                const Ht = () => {
                    null === J.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (J.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
                        document.body.style.paddingRight = "".concat(J.previousBodyPadding + ze(), "px"))
                }
                    , qt = () => {
                    ...
                    , Kt = e => {
                        ...
                        en(t, n, e),
                            ...
                            U() && (Qt(t, e.scrollbarPadding, s),
                                Tt()),
                            K() || xe.previousActiveElement || (xe.previousActiveElement = document.activeElement),
                    ...
                    , Zt = e => {
                        ...
                        if (e.target !== t)
                            return;
                        const n = O();
                        t.removeEventListener(De, Zt),
                            n.style.overflowY = "auto"
                    }
                    , Jt = (e, t) => {
                        De && ve(t) ? (e.style.overflowY = "hidden",
                            t.addEventListener(De, Zt)) : e.style.overflowY = "auto"
                    }
                    , Qt = (e, t, n) => {
                        Gt(),
                            t && "hidden" !== n && Ht(),
                    ...
                    , en = (e, t, n) => {
                        oe(e, n.showClass.backdrop),
                            ...
                            n.heightAuto && n.backdrop && !n.toast && oe([document.documentElement, document.body], k["height-auto"])
                    }
                    , tn = e => {
                        let t = L();
                        t || new Ws,
                    ...
                    , sn = (e, t) => {
                        "select" === t.input || "radio" === t.input ? cn(e, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (d(t.inputValue) || p(t.inputValue)) && (tn(_()),
                            dn(e, t))
                    }
                    , rn = (e, t) => {
                        const n = e.getInput();
                    ...
                    , cn = (e, t) => {
                        ...
                        d(t.inputOptions) || p(t.inputOptions) ? (tn(_()),
                    ...
                    , dn = (e, t) => {
                        const n = e.getInput();
                        ue(n),
                            u(t.inputValue).then((s => {
                                n.value = "number" === t.input ? parseFloat(s) || 0 : "".concat(s),
                                    de(n),
                                    n.focus(),
                                    e.hideLoading()
                            }
                ...
                function yn(e) {
                    ...
                    const t = vn.swalPromiseResolve.get(this)
                        , n = xn(this);
                    this.isAwaitingPromise() ? e.isDismissed || (Sn(this),
                        t(e)) : n && t(e)
                }
                function Cn() {
                ...
                const xn = e => {
                    ...
                    const s = O();
                    return ae(s, n.showClass.backdrop),
                ...
                const Sn = e => {
                    e.isAwaitingPromise() && (Re.awaitingPromise.delete(e),
                    ...
                    , kn = (e, t, n) => {
                        ...
                        "function" == typeof n.willClose && n.willClose(t),
                            i ? Pn(e, t, s, n.returnFocus, n.didClose) : bn(e, s, n.returnFocus, n.didClose)
                    }
                    , Pn = (e, t, n, s, i) => {
                        xe.swalCloseEventFinishedCallback = bn.bind(null, e, n, s, i),
                            t.addEventListener(De, (function (e) {
                                e.target === t && (xe.swalCloseEventFinishedCallback(),
                ...
                function Hn() {
                    ...
                    t ? (e.popup && xe.swalCloseEventFinishedCallback && (xe.swalCloseEventFinishedCallback(),
                        delete xe.swalCloseEventFinishedCallback),
                        xe.deferDisposalTimer && (clearTimeout(xe.deferDisposalTimer),
                ...
                const qn = e => {
                    ...
                    , Gn = e => {
                        e.isAwaitingPromise() ? (Vn(Re, e),
                            Re.awaitingPromise.set(e, !0)) : (Vn(vn, e),
                                Vn(Re, e))
                    }
                    , Vn = (e, t) => {
                        for (const n in e)
                ...
                const Wn = e => {
                    ...
                    , Xn = (e, t) => {
                        ...
                        if (!s.input)
                            return r('The "input" parameter is needed to be set when using returnInputValueOn'.concat(n(t)));
                        const i = rn(e, s);
                        s.inputValidator ? Un(e, i, t) : e.getInput().checkValidity() ? "deny" === t ? Kn(e, i) : Qn(e, i) : (e.enableButtons(),
                            e.showValidationMessage(s.validationMessage))
                    }
                    , Un = (e, t, n) => {
                        const s = Re.innerParams.get(e);
                        e.disableInput(),
                            Promise.resolve().then((() => u(s.inputValidator(t, s.validationMessage)))).then((s => {
                                e.enableButtons(),
                                    e.enableInput(),
                                    s ? e.showValidationMessage(s) : "deny" === n ? Kn(e, t) : Qn(e, t)
                            }
                            ))
                    }
                    , Kn = (e, t) => {
                        ...
                        n.showLoaderOnDeny && tn(N()),
                            n.preDeny ? (Re.awaitingPromise.set(e || void 0, !0),
                                Promise.resolve().then((() => u(n.preDeny(t, n.validationMessage)))).then((n => {
                                    !1 === n ? (e.hideLoading(),
                                        Sn(e)) : e.closePopup({
                                            isDenied: !0,
                                            value: void 0 === n ? t : n
                    ...
                    , Qn = (e, t) => {
                        ...
                        n.showLoaderOnConfirm && tn(),
                            n.preConfirm ? (e.resetValidationMessage(),
                                ...
                                Promise.resolve().then((() => u(n.preConfirm(t, n.validationMessage)))).then((n => {
                                    he(z()) || !1 === n ? (e.hideLoading(),
                                        Sn(e)) : Zn(e, void 0 === n ? t : n)
                                }
                                )).catch((t => Jn(e || void 0, t)))) : Zn(e, t)
                    }
                    , es = (e, t, n) => {
                        Re.innerParams.get(e).toast ? ts(e, t, n) : (is(t),
                            rs(t),
                            os(e, t, n))
                    }
                    , ts = (e, t, n) => {
                ...
                const is = e => {
                        ...
                        e.container.onmousedown = () => {
                            e.popup.onmouseup = function (t) {
                                e.popup.onmouseup = void 0,
                                    (t.target === e.popup || e.popup.contains(t.target)) && (ss = !0)
                            }
                        }
                    }
                    , os = (e, t, n) => {
                    ...
                    , us = (e, t, n, s) => {
                        t.keydownTarget && t.keydownHandlerAdded && (t.keydownTarget.removeEventListener("keydown", t.keydownHandler, {
                            ...
                            n.toast || (t.keydownHandler = t => fs(e, t, s),
                    ...
                    , ps = (e, t, n) => {
                        const s = X();
                        if (s.length)
                            return (t += n) === s.length ? t = 0 : -1 === t && (t = s.length - 1),
                                s[t].focus();
                        L().focus()
                    }
                    ...
                    , fs = (e, t, n) => {
                        const s = Re.innerParams.get(e);
                        s && (t.isComposing || 229 === t.keyCode || (s.stopKeydownPropagation && t.stopPropagation(),
                            "Enter" === t.key ? gs(e, t, s) : "Tab" === t.key ? vs(t, s) : [...ms, ...hs].includes(t.key) ? bs(t.key) : "Escape" === t.key && ws(t, s, n)))
                    }
                    , gs = (e, t, n) => {
                    ...
                    , bs = e => {
                        if (![_(), N(), G()].includes(document.activeElement))
                            return;
                        ...
                        for (let e = 0; e < V().children.length; e++) {
                            if (n = n[t],
                                !n)
                                return;
                            if (he(n) && n instanceof HTMLButtonElement)
                                break
                        }
                ...
                const Bs = {};
                function $s() {
                    Bs[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this,
                        Ls || (document.body.addEventListener("click", Is),
                            Ls = !0)
                }
                const Is = e => {
                ...
                class zs {
                    ...
                    _main(e) {
                        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                        T(Object.assign({}, t, e)),
                            xe.currentInstance && (xe.currentInstance._destroy(),
                                U() && St()),
                            xe.currentInstance = this;
                        const n = Ns(e, t);
                        _t(n),
                            Object.freeze(n),
                            xe.timeout && (xe.timeout.stop(),
                                delete xe.timeout),
                            clearTimeout(xe.restoreFocusTimeout);
                        const s = Hs(this);
                        return Ct(this, n),
                            Re.innerParams.set(this, n),
                            _s(this, s, n)
                    }
                    then(e) {
                ...
                const _s = (e, t, n) => new Promise(((s, i) => {
                    ...
                    , Ns = (e, t) => {
                        ...
                        return s.showClass = Object.assign({}, m.showClass, s.showClass),
                    ...
                    , Hs = e => {
                        ...
                        return Re.domCache.set(e, t),
                            t
                    }
                    , qs = (e, t, n) => {
                        const s = W();
                        ue(s),
                            t.timer && (e.timeout = new Nt((() => {
                                n("timer"),
                                    delete e.timeout
                            }
                            ), t.timer),
                                t.timerProgressBar && (de(s),
                    ...
                    , Gs = (e, t) => {
                        if (!t.toast)
                            return c(t.allowEnterKey) ? void (Vs(e, t) || ps(t, -1, 1)) : Fs()
                    }
                    , Vs = (e, t) => t.focusDeny && he(e.denyButton) ? (e.denyButton.focus(),
                        !0) : t.focusCancel && he(e.cancelButton) ? (e.cancelButton.focus(),
                            !0) : !(!t.focusConfirm || !he(e.confirmButton) || (e.confirmButton.focus(),
                                0))
                    , Fs = () => {
        ...
        (() => {
                ...
                return function (...t) {
                    if (void 0 === t[0]) {
                        for (let t = 0; t < this.length; t += 1)
                            p.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : u(this[t]).trigger(e));
                        return this
                    }
                    return this.on(e, ...t)
                }
                        ...
                        for (let e = 0; e < this.length; e += 1) {
                            ...
                            if (!n && r.dom7Listeners ? o = r.dom7Listeners[t] : n && r.dom7LiveListeners && (o = r.dom7LiveListeners[t]),
                                ...
                                for (let e = o.length - 1; e >= 0; e -= 1) {
                                    const n = o[e];
                                    s && n.listener === s || s && n.listener && n.listener.dom7proxy && n.listener.dom7proxy === s ? (r.removeEventListener(t, n.proxyListener, i),
                                        o.splice(e, 1)) : s || (r.removeEventListener(t, n.proxyListener, i),
                                            o.splice(e, 1))
                                }
                        }
                    }
                ...
                for (let i = 1; i < e.length; i += 1) {
                    ...
                    if (null != r && (s = r,
                        ...
                        for (let n = 0, s = e.length; n < s; n += 1) {
                            ...
                            void 0 !== i && i.enumerable && (w(t[s]) && w(r[s]) ? r[s].__swiper__ ? t[s] = r[s] : y(t[s], r[s]) : !w(t[s]) && w(r[s]) ? (t[s] = {},
                                r[s].__swiper__ ? t[s] = r[s] : y(t[s], r[s])) : t[s] = r[s])
                        }
                    }
                }
                var s;
            ...
            function P(e = {}) {
                return S || (S = function ({ userAgent: e } = {}) {
                    ...
                    const u = i.match(/(iPod)(.*OS\s([\d_]+))?/)
                        ...
                        , m = "Win32" === s;
                    let h = "MacIntel" === s;
                    return !d && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${l}`) >= 0 && (d = i.match(/(Version)\/([\d.]+)/),
                        d || (d = [0, 1, "13_0_0"]),
                        h = !1),
                        c && !m && (r.os = "android",
                            r.android = !0),
            ...
            const M = {
                ...
                updateSlides: function () {
                    ...
                    "string" == typeof w && w.indexOf("%") >= 0 && (w = parseFloat(w.replace("%", "")) / 100 * r),
                        ...
                        s.centeredSlides && s.cssMode && (C(e.wrapperEl, "--swiper-centered-offset-before", ""),
                    ...
                    for (let i = 0; i < u; i += 1) {
                        E = 0;
                        const o = d.eq(i);
                        if (S && e.grid.updateSlide(i, o, u, t),
                            "none" !== o.css("display")) {
                            ...
                            d[i] && (d[i].swiperSlideSize = E),
                                h.push(E),
                                s.centeredSlides ? (y = y + E / 2 + x / 2 + w,
                                    0 === x && 0 !== i && (y = y - r / 2 - w),
                                    0 === i && (y = y - r / 2 - w),
                                    Math.abs(y) < .001 && (y = 0),
                    ...
                    if (e.virtualSize = Math.max(e.virtualSize, r) + g,
                        o && a && ("slide" === s.effect || "coverflow" === s.effect) && i.css({
                ...
                updateSlidesClasses: function () {
                    ...
                    t.removeClass(`${n.slideActiveClass} ${n.slideNextClass} ${n.slidePrevClass} ${n.slideDuplicateActiveClass} ${n.slideDuplicateNextClass} ${n.slideDuplicatePrevClass}`),
                        ...
                        n.loop && (a.hasClass(n.slideDuplicateClass) ? s.children(`.${n.slideClass}:not(.${n.slideDuplicateClass})[data-swiper-slide-index="${r}"]`).addClass(n.slideDuplicateActiveClass) : s.children(`.${n.slideClass}.${n.slideDuplicateClass}[data-swiper-slide-index="${r}"]`).addClass(n.slideDuplicateActiveClass));
                ...
                updateActiveIndex: function (e) {
                    const t = this
                        ...
                        , { slidesGrid: s, snapGrid: i, params: r, activeIndex: o, realIndex: a, snapIndex: l } = t;
                    let c, d = e;
                    if (void 0 === d) {
                        for (let e = 0; e < s.length; e += 1)
                            void 0 !== s[e + 1] ? n >= s[e] && n < s[e + 1] - (s[e + 1] - s[e]) / 2 ? d = e : n >= s[e] && n < s[e + 1] && (d = e + 1) : n >= s[e] && (d = e);
                ...
                updateClickedSlide: function (e) {
                    ...
                    t.clickedSlide = s,
                        t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(f(s).attr("data-swiper-slide-index"), 10) : t.clickedIndex = i,
            ...
            const L = {
                ...
                setTranslate: function (e, t) {
                    const n = this
                        , { rtlTranslate: s, params: i, $wrapperEl: r, wrapperEl: o, progress: a } = n;
                    let l, c = 0, d = 0;
                    n.isHorizontal() ? c = s ? -e : e : d = e,
                        i.roundLengths && (c = Math.floor(c),
                            d = Math.floor(d)),
                        i.cssMode ? o[n.isHorizontal() ? "scrollLeft" : "scrollTop"] = n.isHorizontal() ? -c : -d : i.virtualTranslate || r.transform(`translate3d(${c}px, ${d}px, 0px)`),
            ...
            const $ = {
                slideTo: function (e = 0, t = this.params.speed, n = !0, s, i) {
                    ...
                    let o = e;
                    o < 0 && (o = 0);
                    const { params: a, snapGrid: l, slidesGrid: c, previousIndex: d, activeIndex: u, rtlTranslate: p, wrapperEl: m, enabled: h } = r;
                    if (r.animating && a.preventInteractionOnTransition || !h && !s && !i)
                        return !1;
                ...
                slidePrev: function (e = this.params.speed, t = !0, n) {
                    const s = this
                        , { params: i, animating: r, snapGrid: o, slidesGrid: a, rtlTranslate: l, enabled: c } = s;
                    if (!c)
                        return s;
                    if (i.loop) {
                    ...
                    let h = 0;
                    return void 0 !== m && (h = a.indexOf(m),
                        h < 0 && (h = s.activeIndex - 1),
                        "auto" === i.slidesPerView && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && (h = h - s.slidesPerViewDynamic("previous", !0) + 1,
                            h = Math.max(h, 0))),
                        i.rewind && s.isBeginning ? s.slideTo(s.slides.length - 1, e, t, n) : s.slideTo(h, e, t, n)
                },
                ...
                slideToClickedSlide: function () {
                    ...
                    if (t.loop) {
                        if (e.animating)
                            return;
                        i = parseInt(f(e.clickedSlide).attr("data-swiper-slide-index"), 10),
            ...
            const I = {
                ...
                loopFix: function () {
                    ...
                    const { activeIndex: t, slides: n, loopedSlides: s, allowSlidePrev: i, allowSlideNext: r, snapGrid: o, rtlTranslate: a } = e;
                    let l;
                    e.allowSlidePrev = !0,
                        e.allowSlideNext = !0;
            ...
            function j(e) {
                ...
                if ("wrapper" === o.touchEventsTarget && !u.closest(t.wrapperEl).length)
                    return;
                if (i.isTouchEvent = "touchstart" === d.type,
                ...
                if (o.noSwiping && (m ? function (e, t = this) {
                    return function t(n) {
                        return n && n !== r() && n !== a() ? (n.assignedSlot && (n = n.assignedSlot),
                            n.closest(e) || t(n.getRootNode().host)) : null
                    }(t)
                }(p, d.target) : u.closest(p)[0]))
                    return void (t.allowClick = !0);
                if (o.swipeHandler && !u.closest(o.swipeHandler)[0])
                    return;
                ...
                if (Object.assign(i, {
                    ...
                    u.is(i.focusableElements) && (e = !1),
                        n.activeElement && f(n.activeElement).is(i.focusableElements) && n.activeElement !== u[0] && n.activeElement.blur();
            ...
            function D(e) {
                ...
                if (c.originalEvent && (c = c.originalEvent),
                    !s.isTouched)
                    return void (s.startMoving && s.isScrolling && n.emit("touchMoveOpposite", c));
                ...
                if (s.isTouchEvent && i.touchReleaseOnEdges && !i.loop)
                    if (n.isVertical()) {
                        ...
                        return;
                if (s.isTouchEvent && t.activeElement && c.target === t.activeElement && f(c.target).is(s.focusableElements))
                    return s.isMoved = !0,
                        void (n.allowClick = !1);
                if (s.allowTouchCallbacks && n.emit("touchMove", c),
                ...
                if (void 0 === s.isScrolling) {
                    let e;
                    n.isHorizontal() && o.currentY === o.startY || n.isVertical() && o.currentX === o.startX ? s.isScrolling = !1 : m * m + h * h >= 25 && (e = 180 * Math.atan2(Math.abs(h), Math.abs(m)) / Math.PI,
                        s.isScrolling = n.isHorizontal() ? e > i.touchAngle : 90 - e > i.touchAngle)
                }
                if (s.isScrolling && n.emit("touchMoveOpposite", c),
                ...
                if (i.touchReleaseOnEdges && (w = 0),
                    g > 0 && s.currentTranslate > n.minTranslate() ? (b = !1,
                        i.resistance && (s.currentTranslate = n.minTranslate() - 1 + (-n.minTranslate() + s.startTranslate + g) ** w)) : g < 0 && s.currentTranslate < n.maxTranslate() && (b = !1,
                            i.resistance && (s.currentTranslate = n.maxTranslate() + 1 - (n.maxTranslate() - s.startTranslate - g) ** w)),
            ...
            function z(e) {
                const t = this
                    , n = t.touchEventsData
                    , { params: s, touches: i, rtlTranslate: r, slidesGrid: o, enabled: a } = t;
                if (!a)
                    return;
                let l = e;
                ...
                if (n.isTouched = !1,
                    n.isMoved = !1,
                    n.startMoving = !1,
                    u = s.followFinger ? r ? t.translate : -t.translate : -n.currentTranslate,
                    s.cssMode)
                    return;
                ...
                for (let e = 0; e < o.length; e += e < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup) {
                    ...
                    void 0 !== o[e + t] ? u >= o[e] && u < o[e + t] && (p = e,
                        m = o[e + t] - o[e]) : u >= o[e] && (p = e,
                ...
                if (d > s.longSwipesMs) {
                    ...
                    "next" === t.swipeDirection && (h >= s.longSwipesRatio ? t.slideTo(p + f) : t.slideTo(p)),
                        "prev" === t.swipeDirection && (h > 1 - s.longSwipesRatio ? t.slideTo(p + f) : t.slideTo(p))
                } else {
                    if (!s.shortSwipes)
                        return void t.slideTo(t.activeIndex);
                    t.navigation && (l.target === t.navigation.nextEl || l.target === t.navigation.prevEl) ? l.target === t.navigation.nextEl ? t.slideTo(p + f) : t.slideTo(p) : ("next" === t.swipeDirection && t.slideTo(p + f),
            ...
            const V = (e, t) => {
                const n = r()
                    , { params: s, touchEvents: i, el: o, wrapperEl: a, device: l, support: c } = e
                    , d = !!s.nested
                ...
                if (c.touch) {
                    ...
                    o[u](i.start, e.onTouchStart, t),
                        o[u](i.move, e.onTouchMove, c.passiveListener ? {
                            passive: !1,
                            capture: d
                        } : d),
                ...
                (s.preventClicks || s.preventClicksPropagation) && o[u]("click", e.onClick, !0),
                    ...
                    s.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", _, !0) : e[p]("observerUpdate", _, !0)
            }
                ;
            const F = {
                attachEvents: function () {
                    ...
                    e.onTouchStart = j.bind(e),
                        ...
                        e.onClick = N.bind(e),
                        s.touch && !q && (t.addEventListener("touchstart", G),
                            q = !0),
                        V(e, "on")
                },
            ...
            const R = {
                setBreakpoint: function () {
                    ...
                    const l = (a in o ? o[a] : void 0) || e.originalParams
                        ...
                        , d = W(e, l)
                        , u = i.enabled;
                    c && !d ? (r.removeClass(`${i.containerModifierClass}grid ${i.containerModifierClass}grid-column`),
                        e.emitContainerClasses()) : !c && d && (r.addClass(`${i.containerModifierClass}grid`),
            ...
            const Y = {
                addClasses: function () {
                    const e = this
                        , { classNames: t, params: n, rtl: s, $el: i, device: r, support: o } = e
                        , a = function (e, t) {
                            const n = [];
                            return e.forEach((e => {
            ...
            const K = {
                ...
                images: {
                    loadImage: function (e, t, n, s, i, r) {
                        ...
                        f(e).parent("picture")[0] || e.complete && i ? c() : t ? (l = new o.Image,
                            l.onload = c,
                            l.onerror = c,
                            s && (l.sizes = s),
                            n && (l.srcset = n),
            ...
            class J {
                ...
                slidesPerViewDynamic(e = "current", t = !1) {
                    const { params: n, slides: s, slidesGrid: i, slidesSizesGrid: r, size: o, activeIndex: a } = this;
                    let l = 1;
                    if (n.centeredSlides) {
                        let e, t = s[a].swiperSlideSize;
                        for (let n = a + 1; n < s.length; n += 1)
                            s[n] && !e && (t += s[n].swiperSlideSize,
                                l += 1,
                                t > o && (e = !0));
                ...
                changeDirection(e, t = !0) {
                    ...
                    return e || (e = "horizontal" === s ? "vertical" : "horizontal"),
                        e === s || "horizontal" !== e && "vertical" !== e || (n.$el.removeClass(`${n.params.containerModifierClass}${s}`).addClass(`${n.params.containerModifierClass}${e}`),
            ...
            Object.keys(K).forEach((e => {
                ...
                J.use([function ({ swiper: e, on: t, emit: n }) {
                    const s = a();
                    let i = null;
                    const r = () => {
                    ...
                    t("init", (() => {
                        e.params.resizeObserver && void 0 !== s.ResizeObserver ? e && !e.destroyed && e.initialized && (i = new ResizeObserver((t => {
                            ...
                            t.forEach((({ contentBoxSize: t, contentRect: n, target: s }) => {
                                s && s !== e.el || (i = n ? n.width : (t[0] || t).inlineSize,
                            ...
                            i.observe(e.el)) : (s.addEventListener("resize", r),
            ...
            Q.use([function ({ swiper: e, extendParams: t, on: n, emit: s }) {
                function i(t) {
                    let n;
                    return t && (n = f(t),
                ...
                function r(t, n) {
                    ...
                    t && t.length > 0 && (t[n ? "addClass" : "removeClass"](s.disabledClass),
                ...
                , function ({ swiper: e, extendParams: t, on: n, emit: s }) {
                    ...
                    function c() {
                        ...
                        if (e.params.loop ? (d = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup),
                            ...
                            let i, a, u;
                            if (n.dynamicBullets && (r = s.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                                c.css(e.isHorizontal() ? "width" : "height", r * (n.dynamicMainBullets + 4) + "px"),
                                n.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (o += d - (e.previousIndex - e.loopedSlides || 0),
                                ...
                                s.each((e => {
                                    ...
                                    s === d && t.addClass(n.bulletActiveClass),
                                        n.dynamicBullets && (s >= i && s <= a && t.addClass(`${n.bulletActiveClass}-main`),
                                            s === i && l(t, "prev"),
                                            s === a && l(t, "next"))
                                }
                                ));
                        ...
                        if ("fraction" === n.type && (c.find(te(n.currentClass)).text(n.formatFractionCurrent(d + 1)),
                            ...
                            "horizontal" === t ? i = s : r = s,
                                c.find(te(n.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${r})`).transition(e.params.speed)
                        }
                        "custom" === n.type && n.renderCustom ? (c.html(n.renderCustom(e, d + 1, u)),
                            s("paginationRender", c[0])) : s("paginationUpdate", c[0]),
                    ...
                    function d() {
                        ...
                        if ("bullets" === t.type) {
                            ...
                            i.html(r),
                                e.pagination.bullets = i.find(te(t.bulletClass))
                        }
                    ...
                    function u() {
                        ...
                        0 !== n.length && (e.params.uniqueNavElements && "string" == typeof t.el && n.length > 1 && (n = e.$el.find(t.el),
                            n.length > 1 && (n = n.filter((t => f(t).parents(".swiper")[0] === e.el)))),
                ...
                , function ({ swiper: e, extendParams: t, on: n, emit: s }) {
                    ...
                    function d() {
                        ...
                        "hidden" === t.visibilityState && e.autoplay.running && c(),
                            "visible" === t.visibilityState && e.autoplay.paused && (o(),
                                e.autoplay.paused = !1)
                    }
                    function u(t) {
                ...
                , function ({ swiper: e, extendParams: t, on: n }) {
                    t({
                        ...
                        function (e) {
                            const { effect: t, swiper: n, on: s, setTranslate: i, setTransition: r, overwriteParams: o, perspective: a } = e;
                            s("beforeInit", (() => {
                            ...
                            setTransition: t => {
                                ...
                                (n ? e.slides.find(n) : e.slides).transition(t),
                                    function ({ swiper: e, duration: t, transformEl: n, allSlides: s }) {
                ...
                , function ({ swiper: e, extendParams: t, on: n }) {
                    ...
                    function r() {
                        ...
                        if (null == n)
                            return;
                        let i;
                        if (i = t.params.loop ? parseInt(f(t.clickedSlide).attr("data-swiper-slide-index"), 10) : n,
                            e.params.loop) {
                            let t = e.activeIndex;
                    ...
                    function a(t) {
                        ...
                        if (e.realIndex !== n.realIndex || r) {
                            ...
                            if (n.params.loop) {
                                ...
                                o = void 0 === t ? s : void 0 === s ? t : s - l == l - t ? n.params.slidesPerGroup > 1 ? s : l : s - l < l - t ? s : t,
                                    a = e.activeIndex > e.previousIndex ? "next" : "prev"
                            } else
                                o = e.realIndex,
                                    a = o > e.previousIndex ? "next" : "prev";
                            r && (o += "next" === a ? i : -1 * i),
                                n.visibleSlidesIndexes && n.visibleSlidesIndexes.indexOf(o) < 0 && (n.params.centeredSlides ? o = o > l ? o - Math.floor(s / 2) + 1 : o + Math.floor(s / 2) - 1 : o > l && n.params.slidesPerGroup,
                        ...
                        if (e.params.slidesPerView > 1 && !e.params.centeredSlides && (o = e.params.slidesPerView),
                            ...
                            for (let t = 0; t < o; t += 1)
                                n.$wrapperEl.children(`[data-swiper-slide-index="${e.realIndex + t}"]`).addClass(a);
                        else
                            for (let t = 0; t < o; t += 1)
